...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
                <p class="card-text">
                    <a href="home.php" class="float-right"><i class="fa fa-chevron-circle-left go-back"></i> <?php echo lng('Back')?></a>
        ...
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            if ($parent !== false) {
                ...
                <tr><?php if (!FM_READONLY): ?>
                    ...
                    <td class="border-0" data-sort></td>
                    <td class="border-0" data-order></td>
                    <td class="border-0" data-order></td>
                    <td class="border-0"> <a href="home.php"><i class="fa fa-chevron-circle-left go-back"></i> Back</a></td>
                    <?php if (!FM_IS_WIN && !$hide_Cols) { ?>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9">
            <ul class="list-inline footer-action">
                ...
                <!--
                    dont think you need these functions for doing things to the files
        -->
                <!--
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            echo '<div class="col-xs-6 col-sm-5"></div>';
            ?>
            ...
            <div class="col-xs-6 col-sm-7 text-right">
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
                    ...
                    <li class="nav-item">
                        <a title="<?php echo lng('Download') ?>" class="nav-link" href="?p=uploads"><i class="fa fa-plus-square"></i> <?php echo lng('Download') ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if (FM_USE_AUTH): ?>
